...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <a
        href="https://wa.me/573134804546?text=Hola%20AgTech%20Colombia%2C%20me%20interesa%20saber%20m%C3%A1s%20sobre%20la%20plataforma."
        target="_blank"
        rel="noreferrer"
      ...
      >
        ...
        <span className="relative flex items-center justify-center w-14 h-14 rounded-full
                         bg-green-500 shadow-xl shadow-green-500/40
